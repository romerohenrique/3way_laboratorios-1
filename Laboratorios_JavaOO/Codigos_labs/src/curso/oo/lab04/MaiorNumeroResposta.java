...
public class MaiorNumeroResposta {
	...
	public static void main(String[] args) {
		...
		int[] num = new int[10];
		int contador;
		// todo 1 - altere o nome para facilitar na leitura para menorNumero - Utilize o
		// refactor da IDE (Peça ajuda)
		int menorNumero = 0;
		int numerostotal = 3;
		...
		for (contador = 0; contador < numerostotal; contador++) {
			...
			num[contador] = Integer
					.parseInt(JOptionPane.showInputDialog("Entre com números até " + numerostotal + " no total"));
